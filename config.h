...
#define PACKAGE_BUGREPORT "airween@digitalwave.hu"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ftwrunner"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ftwrunner 0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ftwrunner"
